...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/smartwriter1)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/smartwriter1
```

A live public deployment of this template is available at [https://smartwriter1.templates.workers.dev](https://smartwriter1.templates.workers.dev)
